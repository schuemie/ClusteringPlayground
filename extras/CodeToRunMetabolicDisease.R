...
outputFolder <- "s:/temp/ClusteringMetabolicDisease"
...
constructFeaturesMetabolicDisease(connectionDetails = connectionDetails,
                                  cdmDatabaseSchema = cdmDatabaseSchema,
                                  cohortDatabaseSchema = cohortDatabaseSchema,
                                  cohortTable = cohortTable,
...
computeDistance(outputFolder = outputFolder,
                minFeaturesPerPerson = 5, # A lot lower because only few features
